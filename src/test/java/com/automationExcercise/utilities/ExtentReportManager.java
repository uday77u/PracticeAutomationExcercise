...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		*/
		...
		sparkReporter.config().setReportName("AutomationExcercise Functional Testing"); // name of the report
		sparkReporter.config().setTheme(Theme.DARK);
		
		extent = new ExtentReports();
		extent.attachReporter(sparkReporter);
		extent.setSystemInfo("Application", "AutomationExcercise");
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			String imgPath = new com.automationExcercise.BaseTest.BaseClass().captureScreen(result.getName());
